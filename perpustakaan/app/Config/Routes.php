...
$routes->get('/borrowings/history', 'BorrowingController::history');  // Menampilkan riwayat borrowing user
$routes->get('/borrowings/borrow/(:num)/(:num)', 'BorrowingController::borrow/$1/$2');
$routes->get('/borrowings/borrow/(:num)', 'BorrowingController::borrow/$1');
